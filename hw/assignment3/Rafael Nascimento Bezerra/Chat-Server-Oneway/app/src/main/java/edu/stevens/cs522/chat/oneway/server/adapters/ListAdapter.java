 ...
 */
public class ListAdapter extends ArrayAdapter<ReceivedMessage> {
    /**
     * Constructor
     *
     ...
     */
    public ListAdapter(Context context, int resource, List<ReceivedMessage> objects) {
        super(context, resource, objects);
    }

    public View getView(int position, View convertView, ViewGroup parent) {
        ReceivedMessage item = getItem(position);

...
//    final static public String EXTRA_RESULT_RECEIVER = TAG + "_result_receiver";
//    final static public int RESULT_RECEIVER_RESULT_CODE_SUCCESS = 0;
//    final static public int RESULT_RECEIVER_RESULT_CODE_ERROR = 1;
//
...
//            ResultReceiver resultReceiver = bundle.getParcelable(EXTRA_RESULT_RECEIVER);
//
...
//
//            Log.d(TAG, msg);
//            int code = RESULT_RECEIVER_RESULT_CODE_ERROR;
//            try {
//
...
//                clientSocket.close();
//
//                code = RESULT_RECEIVER_RESULT_CODE_SUCCESS;
//

...
public class ContactRowAdapter extends ResourceCursorAdapter {
    ...
    public View newView(Context context, Cursor cur, ViewGroup parent) {
        ...
        return inflater.inflate(R.layout.contact_list_row, parent, false);
    }
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        TextView name = (TextView) view.findViewById(R.id.contact_list_row_user_name);
        TextView location = (TextView) view.findViewById(R.id.contact_list_row_user_location);
